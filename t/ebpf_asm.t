...
subtest 'Test ebpf::asm basic functionality' => sub {
    ...
    is(unpack('H*', $serialized), '1812000003000000', 'Serialized output is correct');
...
subtest 'Test ebpf::asm constructors' => sub {
    ...
    my $asm2 = ebpf::asm->new({ code => 0x18, dst_reg => 0x2, src_reg => 0x1, off => 0, imm => 0x3 });
    my $asm3 = ebpf::asm->new(code => 0x18, dst_reg => 0x2, src_reg => 0x1, off => 0, imm => 0x3);

    is_deeply($asm1, $asm2, "Ordered parameters constructor matches hash ref constructor");
    is_deeply($asm1, $asm3, "Ordered parameters constructor matches named parameters constructor");
};
...
subtest 'Test ebpf::asm macros add' => sub {
    ...
    is($add_reg->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_ADD | ebpf::asm::BPF_X, 'ALU64 REG ADD code is correct');
    ...
    is($add_imm->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_ADD | ebpf::asm::BPF_K, 'ALU64 IMM ADD code is correct');
    ...
    is($alu32_reg->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_ADD | ebpf::asm::BPF_X, 'ALU32 REG ADD code is correct');
    ...
    is($alu32_imm->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_ADD | ebpf::asm::BPF_K, 'ALU32 IMM ADD code is correct');
...
subtest 'Test ebpf::asm macros load' => sub {
    ...
    is($ld_imm32->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_MOV | ebpf::asm::BPF_K, 'LD_IMM32 code is correct');
...
subtest 'Test ebpf::asm macros sub' => sub {
    ...
    is($sub64_reg->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_SUB | ebpf::asm::BPF_X, 'ALU64 REG SUB code is correct');
    ...
    is($sub64_imm->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_SUB | ebpf::asm::BPF_K, 'ALU64 IMM SUB code is correct');
    ...
    is($sub32_reg->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_SUB | ebpf::asm::BPF_X, 'ALU32 REG SUB code is correct');
    ...
    is($sub32_imm->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_SUB | ebpf::asm::BPF_K, 'ALU32 IMM SUB code is correct');
...
subtest 'Test ebpf::asm macros mul' => sub {
    ...
    is($mul32_reg->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_MUL | ebpf::asm::BPF_X, 'ALU32 REG MUL code is correct');
    ...
    is($mul64_reg->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_MUL | ebpf::asm::BPF_X, 'ALU64 REG MUL code is correct');
...
subtest 'Test ebpf::asm macros div' => sub {
    ...
    is($div32_imm->get_code, ebpf::asm::BPF_ALU | ebpf::asm::BPF_DIV | ebpf::asm::BPF_K, 'ALU32 IMM DIV code is correct');
    ...
    is($div64_imm->get_code, ebpf::asm::BPF_ALU64 | ebpf::asm::BPF_DIV | ebpf::asm::BPF_K, 'ALU64 IMM DIV code is correct');
...
subtest 'Test ebpf::asm macros cond' => sub {
    ...
    is($jmp_eq->get_code, ebpf::asm::BPF_JMP | ebpf::asm::BPF_JEQ | ebpf::asm::BPF_K, 'JMP IMM JEQ code is correct');
    ...
    is($jmp_reg->get_code, ebpf::asm::BPF_JMP | ebpf::asm::BPF_JEQ | ebpf::asm::BPF_X, 'JMP REG JEQ code is correct');
    ...
    is($jmp_lt_imm->get_code, ebpf::asm::BPF_JMP | ebpf::asm::BPF_JLT | ebpf::asm::BPF_K, 'JMP IMM JLT code is correct');
